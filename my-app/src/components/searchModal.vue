<template>
  ...
  >
    ...
    >
      ...
      <a-row>
        <a-col :span="24" style="text-align: right">
          ...
          <a-button style="margin: 0 8px" @click="resetformClick"
            >重置</a-button
          >
    ...
    <a-table
      rowKey="id"
      :row-selection="{ selectedRowKeys, onChange, getCheckboxProps }"
...
const props = defineProps(["visible", "selectedRowKeys"]);
...
const ok = () => {
  emits("select", selectedRowKeys.value, selectedRows.value);
